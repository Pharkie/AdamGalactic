...
bme = BreakoutBME68X(i2c) # Declare once. If you put this in a function and keep calling it, it will crash the panel after a while. # type: ignore
...
clock_digits_x = [base_x, base_x + 1 * char_width, base_x + (2 * char_width) + 2,
